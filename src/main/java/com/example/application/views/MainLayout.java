...
import com.example.application.views.allprocomponent.AllProComponentView;
 ...
 */
@PWA(name = "AllComponent", shortName = "AllComponent", enableInstallPrompt = false)
@Push
@Theme(themeFolder = "allcomponent")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("AllComponent");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("AllProComponent", "la la-globe", AllProComponentView.class), //
